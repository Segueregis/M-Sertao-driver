...
import 'package:moto_sertao_flutter_drivers/authentication/signup_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> loginDriverNow(BuildContext context) async {
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (BuildContext c) {
        return const ProgressDialog(message: "Processando ... Por favor aguarde...",);
      },
    );
    ...
    try {
      ...
      if (firebaseUser != null) {
        DatabaseReference driversRef = FirebaseDatabase.instance.ref().child("Motorcyclists");
